...
<div style="height: 158px;width:1200px ;font-weight: bold;letter-spacing: 1px;font-family: courier new;">
	...
	<div><ul style="float: right;list-style: none;font-weight: bold; padding: 20px;margin-top: 60px;font-size: 1.1em">
		...
		<li style="display: inline;font-weight: bold;margin-left: 10px;border: 1px solid #1E1010;background: #FEEAB7 url(images/img2.gif) repeat-x left bottom;border-right-color: #7A6D6D;border-bottom-color: #7A6D6D;color: #FFFFFF;font-weight: bold;"><a href="displaydata.php">Books</a></li>
		<li style="display: inline;font-weight: bold;margin-left: 10px;border: 1px solid #1E1010;background: #FEEAB7 url(images/img2.gif) repeat-x left bottom;border-right-color: #7A6D6D;border-bottom-color: #7A6D6D;color: #FFFFFF;font-weight: bold;"><a href="syllabus.html">Syllabus</a></li>
		<li style="display: inline;font-weight: bold;margin-left: 10px;border: 1px solid #1E1010;background: #FEEAB7 url(images/img2.gif) repeat-x left bottom;border-right-color: #7A6D6D;border-bottom-color: #7A6D6D;color: #FFFFFF;font-weight: bold;"><a href="query.html">Query</a>/</li>
...
//fetch from database
$sql = "SELECT * from bookdb where bookcategory = 'mechanical'";
...
?>
   <h2>Categories</h2>
		<ul style="font-family: courier new;font-style: bold;">
			...
			<li><a href="mech.php">MECHNANICAL</a></li>
